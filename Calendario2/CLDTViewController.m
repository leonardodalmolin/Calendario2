...
#import "CLDTViewController.h"
#import "CLDDiasViewController.h"

@interface CLDTViewController ()

@end

@implementation CLDTViewController{
    NSArray * m;
}
...
- (void)viewDidLoad
{
    ...
    m = [NSArray arrayWithObjects:@"Janeiro", @"Fevereiro", @"Março", @"Abril", @"Maio", @"Junho", @"Julho", @"Agosto", @"Setembro", @"Outubro", @"Novembro", @"Dezembro",nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [m objectAtIndex:indexPath.row];
    return cell;
}
